...
def mission2():
    for i in lounge["items"]:
        if "pick" == i["id"]:
            ...
            lounge["description"] = """Upon picking this safe in the lounge, i seem to have come across a
...
def mission3():
    for i in entrance_hall["items"]:
        if "key" == i["id"]:
            ...
            entrance_hall["description"] = """ This seems to have unlocked the door, this could be my escape.
"""
            mission["mission_3"] = "complete"


def miss_com():
    if (mission["mission_1"] == "complete") and (mission["mission_2"] == "complete") and \
            (mission["mission_3"] == "complete"):
        game.won = True
