...
#TODO everything in the doctest passes, the print menu works. Cannot make the execute commands function.
...
def execute_go(direction):
    ...
    """
        #TODO Ask about how to make this work
    if direction in player.current_room["exits"]:
        #TODO This works on the first turn, then fails the second time it's run.
...
def execute_take(item_id):
    ...
    if items[item_id] in rooms[current]["items"]:
        print("Item is here")
    else:
